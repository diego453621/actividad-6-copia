...
export class GameMap2_1P extends Phaser.Scene {
    constructor() {
        super('GameMap2_1P');
    ...
    preload() {
        ...
        this.load.setPath('assets/fondo/PNG/game_background_2');
        this.load.image('background2', 'game_background_2.png');
    ...
    create() {
        ...
        this.add.image(512, 384, 'background2').setOrigin(0.5, 0.5);
